...
<div class="blocks_tarif1">
    ...
    <div class="tarcab">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(1))}}" data-limit="{{$inv[0]->limit}}" data-name="{{$inv[0]->name}} {{$inv[0]->cost}}$" data-bb="confirm">Купить</a></li>
        </ul>
    </div>
    <div class="tarcab tarcab2">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(2))}}" data-limit="{{$inv[1]->limit}}" data-name="{{$inv[1]->name}} {{$inv[1]->cost}}$" data-bb="confirm">Купить</a></li>
        </ul>
    </div>
    <div class="tarcab tarcab3">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(3))}}" data-limit="{{$inv[2]->limit}}" data-name="{{$inv[2]->name}} {{$inv[2]->cost}}$" data-toggle="confirmation">Купить</a></li>
        </ul>
    </div>
</div>
<div class="blocks_tarif2">
    <div class="tarcab tarcab4">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(4))}}" data-limit="{{$inv[3]->limit}}" data-name="{{$inv[3]->name}} {{$inv[3]->cost}}$" data-toggle="confirmation">Купить</a></li>
        </ul>
    </div>
    <div class="tarcab tarcab5">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(5))}}" data-limit="{{$inv[4]->limit}}" data-name="{{$inv[4]->name}} {{$inv[4]->cost}}$" data-toggle="confirmation">Купить</a></li>
        </ul>
    </div>
    <div class="tarcab tarcab6">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(6))}}" data-limit="{{$inv[5]->limit}}" data-name="{{$inv[5]->name}} {{$inv[5]->cost}}$" data-toggle="confirmation">Купить</a></li>
        </ul>
    </div>
    <div class="tarcab tarcab7">
        ...
        <ul class="control">
            ...
            <li><a class="buy" href="{{URL::route('user.deposites.buy', array(7))}}" data-limit="{{$inv[6]->limit}}" data-name="{{$inv[6]->name}} {{$inv[6]->cost}}$" data-toggle="confirmation">Купить</a></li>
        </ul>
    </div>
</div>
<!-- Modal -->
