...
<div class="question">
    ...
    <div class="text_answer" style="display: none;">
        Смотрите раздел <a href="{{URL::route('marketing.inv')}}" >«Маркетинг»</a>
    </div>
...
<div class="question">
    ...
    <div class="text_answer" style="display: none;">
        Да, получите! Существуют определенные сроки закрытия тарифных линий.
    </div>
...
<div class="question">
    <div class="arrow_box">13. Как я могу вывести средства?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">14. После того как я сделаю запрос на вывод средств, по истечении какого времени средства будут переведены на мой счёт?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">15. Какой минимальный и максимальный вывод в день?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">16. Пополнив внутренний счет в личном кабинете и не купив тарифную линию, могу ли я вывести деньги на свой кошелек?</div>
    <div class="text_answer" style="display: none;">
        Нет, не можете. Пополнив счет в личном кабинете, вы обязаны купить любую тарифную линию.
    </div>

</div>
<div class="question">
    <div class="arrow_box">17. Есть ли  комиссия на вывод  денежных средств?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">18. В проекте есть реферальная программа?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">19. Как работает система, откуда берутся деньги для выплат?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">20. Что делать, если я не могу войти в свой аккаунт, потому что я забыл пароль?</div>
    <div class="text_answer" style="display: none;">
...
<div class="question">
    <div class="arrow_box">21. Что мне делать, если я не нашел ответа на мой вопрос?</div>
    <div class="text_answer" style="display: none;">
