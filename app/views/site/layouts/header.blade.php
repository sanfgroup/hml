...
<!--             <a href="{{URL::route('user.logout')}}" class="enter">Выход <img src="/images/lock.png" alt=""></a>-->
    ...
    <div style="position: fixed; bottom:0;left: 0;width: 100%;z-index: 100000;background: #fff;text-align: center;">
        <h4>Сайт работает в тестовом режиме, всем пользователям начисляется 1000$ до запуска проекта. После запуска баланс будет обнулён и будет возможность пополнять и выводить деньги.</h4>
    </div>
    <!-- header END -->